...
### Эксперимент для оценки влияния набора данных на качество обучения сети
...
### Эксперимент для оценки влияния ёмкости обучения на его качество
...
### Эксперимент для оценки влияния структуры сети на качество обучения
